...
namespace Neko
{
    namespace Http
    {
        ...
        public:
            ...
            virtual bool WriteRequestParameters(TArray<char>& buffer, const Net::Http::Request& repuest, const ServerApplicationSettings& applicationSettings) const override;
