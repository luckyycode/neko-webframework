...
namespace Neko
{
    namespace Mvc
    {
        bool SessionManager::Store(Session& session)
        {
            ...
            {
                GLogError.log("Mvc") << "Session storage " << GetStoreType() << " not found";
            }
        ...
        void SessionManager::ClearSessionsCache()
        {
            ...
            if (probability > 0)
            {
                ...
                if (result == 0)
                {
                    GLogInfo.log("Mvc") << "Clearning session cache...";
                    ...
                    if (storage != nullptr)
                    {
                        ...
                        CDateTime expiryDate = CDateTime::UtcNow();
        ...
        String SessionManager::GenerateSessionId()
        {
            ...
            if (i == 3)
            {
                GLogError.log("Mvc") << "Couldn't generate session UID!";
            }
